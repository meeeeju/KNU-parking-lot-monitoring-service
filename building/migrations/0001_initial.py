    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "building_num",
                    models.IntegerField(unique=True, verbose_name="건물 번호"),
                ),
                (
                    "building_name",
                    models.CharField(max_length=20, verbose_name="건물 이름"),
                ),
                ("pk_size", models.IntegerField(verbose_name="건물의 총 주차 공간 개수")),
                ("pk_count", models.IntegerField(verbose_name="건물의 주차 가능한 공간의 개수")),
                (
                    "modifiedAt",
                    models.DateTimeField(auto_now=True, verbose_name="최근 수정 시간"),
                ),
            ],
            options={
